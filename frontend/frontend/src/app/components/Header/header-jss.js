...
import flagEn from 'enl-images/en.png';
import flagJP from 'enl-images/jp.png';
...
const flagIcon = {
  ...
  '&[class="jp"]': {
    background: `url(${flagJP}) no-repeat transparent`,
  },
  '&[class="en"]': {
    background: `url(${flagEn}) no-repeat transparent`,
  },
};
