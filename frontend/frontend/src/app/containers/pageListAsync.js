...
export const NotFoundDedicated = loadable(() =>
  ...
  export const TabScreen = loadable(() =>
  import ('./Pages/Tab/TabScreen'), {
    fallback: <Loading />,
  });
  ...
  import ('./Pages/Data/Data'), {
    fallback: <Loading />,
  });

  export const Administrator = loadable(() =>
  import ('./Pages/Administrator/Administrator'), {
    fallback: <Loading />,
  });

  export const Alarm = loadable(() =>
  import ('./Pages/Alarm/Alarm'), {
    fallback: <Loading />,
  });

  export const Operation = loadable(() =>
  import ('./Pages/Operation/Operation'), {
    fallback: <Loading />,
  });